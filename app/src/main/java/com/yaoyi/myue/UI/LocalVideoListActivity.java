...
/*本地视频列表*/
public class LocalVideoListActivity extends BaseActivity implements LoaderManager.LoaderCallbacks<Cursor>,VideoAdapter.OnVideoSelectListener {
    ...
    private void initView() {
        ivClose= (ImageView) findViewById(R.id.iv_close1);//叉按钮
    ...
    public void onSelect(final String path, String cover) {
        ...
        mDialog.setPositiveButton("加滤镜", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(!TextUtils.isEmpty(path)){
                    Intent intent=new Intent(LocalVideoListActivity.this,PreviewActivity.class);
        ...
        mDialog.setNegativeButton("分离音频", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(!TextUtils.isEmpty(path)){
                    Intent intent=new Intent(LocalVideoListActivity.this,AudioPreviewActivity.class);
                    intent.putExtra("path",path);
                    startActivity(intent);
                    dialog.dismiss();
                }
