package com.yaoyi.myue.Data.Adapter;
 ...
 * 本地视频列表
 */
public class VideoAdapterH extends CursorAdapter {
    HomeActivity activity;

    MediaMetadataRetriever retriever;

    public VideoAdapterH(Context context, Cursor c) {
        super(context, c);
        retriever=new MediaMetadataRetriever();
    }

    public VideoAdapterH(Context context, Cursor c, boolean autoRequery) {
        super(context, c, autoRequery);
    }

    public VideoAdapterH(Context context, Cursor c, int flags) {
