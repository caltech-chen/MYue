package com.yaoyi.myue.mediacodec;
/*
...
import com.yaoyi.myue.drawer.VideoDrawer;
import com.yaoyi.myue.media.VideoInfo;
import com.yaoyi.myue.MyApplication;
...
//        mSurfaceTexture = new SurfaceTexture(mTextureRender.getTextureId());
        mSurfaceTexture = mDrawer.getSurfaceTexture();//与VideoDrawer中的surfaceTexture关联，VideoDrawer中的surfaceTexture即与纹理绑定的SurfaceTexture
        ...
        mSurface = new Surface(mSurfaceTexture);//surface与mSurfaceTexture关联，其中surface 是解码出来的
// Surface
    }
